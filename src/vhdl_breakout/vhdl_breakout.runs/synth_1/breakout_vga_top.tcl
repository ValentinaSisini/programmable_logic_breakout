...
synth_design -top breakout_vga_top -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef breakout_vga_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file breakout_vga_top_utilization_synth.rpt -pb breakout_vga_top_utilization_synth.pb"  } 
