...
HD_PWD='/home/valentina/Documents/Repo/circuit_breakout/src/vhdl_breakout/vhdl_breakout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breakout_vga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breakout_vga_top.tcl
