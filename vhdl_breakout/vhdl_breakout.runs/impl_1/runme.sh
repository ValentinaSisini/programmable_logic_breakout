...
HD_PWD='/home/valentina/Documents/Repo/circuit_breakout/vhdl_breakout/vhdl_breakout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breakout_vga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breakout_vga_top.tcl -notrace
